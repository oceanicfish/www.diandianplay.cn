...
<html>
<head>
	<script src="<?php echo get_template_directory_uri() . '/core/admin/shortcodes/popup.js' ?>"></script>
</head>
<body>
...
<div class="cws-shortcode-container" id="cws-shortcode-container">
	...
	<br/>
	<input type="submit" class="button button-primary button-large" id="cws_insert_button" value="<?php _e('Insert Shortcode','happykids') ?>">
</div>
