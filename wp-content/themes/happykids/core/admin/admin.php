<?php
	class Theme_admin {
		...
		function admin_styles($a){
			...
			global $typenow;
			if ( ($a == 'post.php' || $a == 'post-new.php' ) && ('page' === $typenow || 'post' === $typenow) || $a == 'toplevel_page_theme_general' || $a == 'widgets.php') {
				wp_enqueue_style( 'font-awesome-admin' , get_template_directory_uri() . '/front/css/font-awesome.css' );
			}
		...
		function admin_scripts($a){
			...
			global $typenow;
			if ( ($a == 'post.php' || $a == 'post-new.php') && ('page' === $typenow || 'post' === $typenow) || $a == 'widgets.php' || $a == 'toplevel_page_theme_general' ) {
				wp_enqueue_script( 'select2-js', get_template_directory_uri() . '/core/admin/functions/select2/select2.js', array('jquery') );
				wp_enqueue_style( 'select2-css', get_template_directory_uri() . '/core/admin/functions/select2/select2.css', false, '2.0.0' );
				wp_enqueue_media();
			}
