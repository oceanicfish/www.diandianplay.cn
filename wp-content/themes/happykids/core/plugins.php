<?php
	...
	function cws_register_required_plugins()	{
			if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) && !in_array( 'ti-woocommerce-wishlist-premium/ti-woocommerce-wishlist-premium.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
				$cws_add_wish_list = array(
											'name'					=> esc_html__( 'WooCommerce Wishlist Plugin', 'kiddy' ), // The plugin name
											'slug'					=> 'ti-woocommerce-wishlist', // The plugin slug (typically the folder name)
			...
			$plugins = array( $cws_add_wish_list,
			array(
