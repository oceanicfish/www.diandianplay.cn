...
class CS_Social_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if($style == 'style-5') {
            ...
            if ($link_facebook != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Facebook" href="'.esc_url($link_facebook).'"><i class="'.$icon_facebook.'"></i></a>';
            }

            if ($link_rss != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Rss" href="'.esc_url($link_rss).'"><i class="'.$icon_rss.'"></i></a>';
            }

            if ($link_youtube != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="YouTube" href="'.esc_url($link_youtube).'"><i class="'.$icon_youtube.'"></i></a>';
            }

            if ($link_twitter != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Twitter" href="'.esc_url($link_twitter).'"><i class="'.$icon_twitter.'"></i></a>';
            }

            if ($link_google != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Google" href="'.esc_url($link_google).'"><i class="'.$icon_google.'"></i></a>';
            }

            if ($link_skype != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Skype" href="'.esc_url($link_skype).'"><i class="'.$icon_skype.'"></i></a>';
            }

            if ($link_yahoo != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Yahoo" href="'.esc_url($link_yahoo).'"><i class="'.$icon_yahoo.'"></i></a>';
            }

            if ($link_dribbble != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Dribbble" href="'.esc_url($link_dribbble).'"><i class="'.$icon_dribbble.'"></i></a>';
            }

            if ($link_flickr != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Flickr" href="'.esc_url($link_flickr).'"><i class="'.$icon_flickr.'"></i></a>';
            }

            if ($link_linkedin != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Linkedin" href="'.esc_url($link_linkedin).'"><i class="'.$icon_linkedin.'"></i></a>';
            }

            if ($link_vimeo != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Vimeo" href="'.esc_url($link_vimeo).'"><i class="'.$icon_vimeo.'"></i></a>';
            }

            if ($link_pinterest != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Pinterest" href="'.esc_url($link_pinterest).'"><i class="'.$icon_pinterest.'"></i></a>';
            }
            ...
            if ($link_instagram != '') {
                echo '<a class="header-content-social" target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="Instagram" href="'.esc_url($link_instagram).'"><i class="'.$icon_instagram.'"></i></a>';
            }
            echo '</div>';
        } else {
            if (!empty($title))
    ...
    function form( $instance ) {
         ...
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('style') ); ?>" name="<?php echo esc_attr( $this->get_field_name('style') ); ?>">
            ...
            <option value="bg_dark"<?php if( $style == 'bg_dark' ){ echo 'selected="selected"';} ?>><?php _e('Dark Background', THEMENAME); ?></option>
         </select>
         </p>
