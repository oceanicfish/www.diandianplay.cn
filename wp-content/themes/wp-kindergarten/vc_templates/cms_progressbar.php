<div class="cms-progress-wraper cms-progress-layout-default <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="cms-progress-body">
        <?php
            ...
            $cms_progress_custom_icon = !empty($atts['cms_progress_custom_icon']) ? $atts['cms_progress_custom_icon'] : '';
            $cms_progress_icon_color = !empty($atts['cms_progress_icon_color']) ? $atts['cms_progress_icon_color'] : '' ;
            $cms_progress_icon_font_size = !empty($atts['cms_progress_icon_font_size']) ? $atts['cms_progress_icon_font_size'] : '';
            $uqid = uniqid();
            ?>
