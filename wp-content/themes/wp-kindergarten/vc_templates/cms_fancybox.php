...
?>
<div id="<?php echo esc_attr($id_link); ?>" class="cms-fancyboxes-wraper cms-fancybox-layout-default <?php echo esc_attr($atts['template']);?>">
  <style type="text/css" scoped>
    #<?php echo esc_attr($id_link); ?>.cms-fancybox-layout-default .cms-fancyboxes-readmore a:hover {
  ...
  <div class="cms-fancyboxes-body">
    <div class="cms-fancyboxes-item">
      ...
      <div class="cms-fancy-box-image">
        <span style="background-color: <?php echo esc_attr($cms_fancybox_bg_color); ?>; border-color: <?php echo esc_attr($cms_fancybox_boder_color); ?>">
