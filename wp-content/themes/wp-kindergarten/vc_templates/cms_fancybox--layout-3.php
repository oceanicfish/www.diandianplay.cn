...
?>
<div id="<?php echo esc_attr($id_link); ?>" class="cms-fancyboxes-wraper cms-fancybox-layout-3 <?php echo esc_attr($atts['template']);?>">
  <style type="text/css" scoped>
    #<?php echo esc_attr($id_link); ?>.cms-fancybox-layout-3 .cms-fancyboxes-readmore a:hover {
